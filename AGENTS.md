...
> 详细规范索引：`docs/00-spec/00-readme.md`；分类索引：`docs/00-spec/00-governance/00-readme.md`、`docs/00-spec/10-engineering/00-readme.md`、`docs/00-spec/20-contracts/00-readme.md`、`docs/00-spec/30-quality-delivery/00-readme.md`、`docs/00-spec/40-security/00-readme.md`、`docs/00-spec/50-ui/00-readme.md`。
...
- ❌ 不读文档直接编码
- ❌ 任务与现有需求/设计文档不符时，不经用户确认直接出方案或编码
- ❌ 用户确认需求变更后，不更新文档直接编码
- ❌ 不探查现有代码直接新建文件
- ❌ 不输出方案直接动手
