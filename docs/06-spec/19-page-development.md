...
- 前端分层、TypeScript、路由和请求基础见 `docs/06-spec/03-frontend.md`。
- 通用视觉、状态、响应式和可访问性见 `docs/06-spec/18-frontend-design.md`。
- 滚动区域和滚动拥有者见 `docs/06-spec/13-scroll-container.md`。
...
- 前端通用设计：`docs/06-spec/18-frontend-design.md`
