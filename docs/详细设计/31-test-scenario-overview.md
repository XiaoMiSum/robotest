...
环境管理（SRS 3.7.1）的相关设计见《环境管理详细设计说明书》（`docs/详细设计/README.md`）。

### 1.3 参考资料

- 《接口测试需求规格说明书》（`docs/需求/README.md`，3.4、3.9–3.11）
- 《概要设计说明书》（`docs/概要/概要设计说明书.md`，3.1、4.2–4.3）
...
| 分册 | 文件 | 覆盖章节 |
|---|---|---|
| 总览 | `31-test-scenario-overview.md` | 前言、1. 引言、2. 数据设计、4.5 复制与链接引用语义、4.6 配置继承与合并、6.2 链接引用刷新策略 |
