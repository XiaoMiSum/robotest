...
> 场景执行引擎见《测试场景详细设计说明书》（`docs/详细设计/README.md`）与《场景执行详细设计说明书》（`docs/详细设计/场景执行详细设计说明书.md`）；接口导入引擎见《接口管理详细设计说明书》（`docs/详细设计/README.md`）。

### 1.3 参考资料

- 《接口测试需求规格说明书》（`docs/需求/README.md`，3.6）
- 《概要设计说明书》（`docs/概要/概要设计说明书.md`，4.4、4.7）
