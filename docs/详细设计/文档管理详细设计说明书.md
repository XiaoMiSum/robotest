...
| 原设计 | 位置 | 替代方式 |
| --- | --- | --- |
| `test_case_module`（功能测试模块中的文档节点） | `docs/详细设计/README.md` 2.1.1 | type=document 的行迁移至 `test_case_document` 表；type=directory 的行迁移至 `project_module`，见 `docs/详细设计/项目模块详细设计说明书.md` |
