...
本版本变更对应的交互设计见 `docs/交互设计/README.md`；登录审计写入与审计查询接口变更见 `docs/详细设计/审计查询详细设计说明书.md`。用户/空间/角色的既有接口与数据设计，除本文档明确标注「新增」「扩展」之处外均保持不变。

### 1.3 参考资料

- 《软件测试平台需求规格说明书》
- 《软件测试平台概要设计说明书》
- 《系统管理模块页面交互设计》（`docs/交互设计/README.md`）
...
| `docs/交互设计/README.md`、`docs/详细设计/README.md` | 对应交互设计与本设计文档 |
