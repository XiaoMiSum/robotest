...
> 接口管理与接口定义编辑见 `docs/交互设计/README.md`。
...
接口管理列表与接口定义编辑见 `docs/交互设计/README.md`。

接口定义是测试场景与 Mock 服务的数据底座，本域产出的接口资产被 `docs/交互设计/README.md`、`docs/交互设计/README.md` 引用。
...
- 接口定义的列表管理与编辑维护见 `docs/交互设计/README.md`。
