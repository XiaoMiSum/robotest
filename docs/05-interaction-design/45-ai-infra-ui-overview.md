...
> 导航框架与色彩体系分别见 `docs/05-interaction-design/02-global-navigation.md`、`docs/05-interaction-design/03-visual-design.md`，本文档只描述 AI 能力域增量。
...
- 限流超限（错误码 1000013004）：Toast 明确提示「AI 调用过于频繁，请稍后再试」；
