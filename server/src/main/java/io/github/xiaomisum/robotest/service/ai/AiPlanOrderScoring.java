 ...
 */
final class AiPlanOrderScoring {
     ...
     */
    static double score(double w1, double w2, double w3,
     ...
     */
    record RankKey(double score, double priorityWeight, int relatedBugCount, int sortOrder) {

        static int compare(RankKey a, RankKey b) {
     ...
     */
    static boolean isStale(String storedPlanSyncedAt, LocalDateTime currentSnapshotSyncedAt) {
